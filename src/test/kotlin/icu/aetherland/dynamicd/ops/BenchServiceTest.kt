...
class BenchServiceTest {
    ...
    fun `runs and persists benchmark report`() {
        ...
        assertTrue(report.reloadP95Ms >= 0)
        assertTrue(report.reloadP99Ms >= 0)
        ...
        assertTrue(latest.verdict.isNotBlank())
        ...
        assertTrue(suite.avgReloadP95Ms >= 0)
        assertTrue(suite.avgReloadP99Ms >= 0)
        assertTrue(suite.verdict.isNotBlank())
